...
<template>
  <section class="faqs-section flex items-center relative pt-48 pb-40">
    <div class="container text-center pt-20">
        <div class="text-white">
          <h3 class="text-3xl lg:text-4xl xl:text-5xl 3xl:text-5.5xl w-full xl:w-2/4 md:w-full mx-auto font-bold pb-5">
            {{ faqsContent.heading }}
          </h3>
      ...
      <div class="faqs-wrapper hidden flex-col gap-4 pd-5 md:px-10 xl:px-20 pt-20 2xl:pt-26">
        <div
